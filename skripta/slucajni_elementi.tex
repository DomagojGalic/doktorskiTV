...
\begin{lm}  \label{lm:3.4}
    Ako je $f: D \to K$ preslikavanje i $\famC \subseteq \partitive{K}$, tada je \begin{equation*}
        \sigAlg{\praslika{f}(\famC)} = \praslika{f} (\sigAlg{\famC}).
    \end{equation*}
\end{lm}
...
\begin{nap} \label{nap:3.9}
    ...
    Uo\v cimo da skup $\skup{\omega \in \Omega}{\omega \; \textnormal{zadovoljava} \; S}$ ne mora biti doga\dj aj.

    ...
    \begin{enumerate}
        ...
        \begin{figure}[H]
            ...
            \begin{tikzpicture}
                ...
                {
                \Big( \produkt{t \in T}{} X_t, \; \borel{\produkt{t \in T}{} X_t} \Big) & \Big( \produkt{t \in T}{} X_t, \; \dirProd{t \in T}{} \borel{X_t} \Big) \\
                & \big( X_{t_0}, \; \borel{X_{t_0}} \big) \\};
                \path[-stealth]
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        {
        \urePar{\Omega}{\famF} & \\
        \Big( \produkt{t \in T}{} E_t, \: \dirProd{t \in T}{} \famE_t \Big) & \urePar{E_{t_0}}{\famE_{t_0}} \\};
        \path[-stealth]

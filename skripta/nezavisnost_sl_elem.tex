...
\begin{tm}  \label{tm:7.4}
    Neka je $n \in \nat$, $\urePar{E_1}{\famE_1}, \ldots, \urePar{E_n}{\famE_n}$ izmjerivi prostori i $X_1 : \Omega \to E_1, \ldots, X_n : \Omega \to E_n$, slu\v cajni elementi.
...
\begin{proof}
    ...
    To je po definiciji upravo $\masP_X * \masP_Y$.
\end{proof}
...
\begin{nap} \label{nap:7.19}
    ...
    Neka je $\Omega := \segment{0}{1}^n$, $\famF := \borel{\segment{0}{1}^n}$, $\masP := \restr{\lambda^n}{\famF}$, te neka je $U_i : \pi_i : \Omega \to \segment{0}{1}, \; i = 1, \ldots, n$.
\end{nap}
